          ...
          <div className="measure">
            <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
              ...
              <div className="mv3">
                ...
                <input
                  className="bw1 b pa2 input-reset ba bg-transparent hover-bg-black-60 hover-white-80 w-100"
                  type="password"
                  name="password"
                  id="password"
            ...
            <div className="">
              <input
                ...
                className="br-pill bw1  b ph3 pv2 input-reset ba b--black bg-transparent grow pointer f6 dib"
                type="submit"
                value="Register"
              />
            </div>
